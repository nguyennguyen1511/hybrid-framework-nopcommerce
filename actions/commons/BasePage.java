...
public class BasePage {
	...
	public void sendKeysToElement (WebDriver driver, String xpathLocator, String valueText) {
		WebElement element = getWebElement(driver, xpathLocator);
		element.clear();
		element.sendKeys(valueText);
	}
	
	public void selectItemInDefaultDropdow(WebDriver driver, String xpathLocator, String textItem) {
		Select select = new Select(getWebElement(driver, xpathLocator));
		select.selectByValue(textItem);
		
	}
	
	public String getSelectedItemInDefaultDropdow(WebDriver driver, String xpathLocator) {
		Select select = new Select(getWebElement(driver, xpathLocator));
		return select.getFirstSelectedOption().getText();
		
	}
	
	public boolean isDropdowMultiple(WebDriver driver, String xpathLocator) {
		Select select = new Select(getWebElement(driver, xpathLocator));
	...
	public boolean isElementEnbled(WebDriver driver, String xpathLocator) {
	...
	public void waitForAllElementclickAbled(WebDriver driver, String xpathLocator) {
		WebDriverWait explicitWait = new WebDriverWait (driver, longTimeout); 
